...
$sql = "SELECT id, title, start, fim, color FROM events ";
			...
			<form class="form-horizontal" method="POST" action="php/calendario/addEvent.php">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <select name="title" id="title" class="col-sm-12 selectpicker" data-hide-disabled="true" data-live-search="true">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
                        <select name="color" id="color" class="col-sm-10 selectpicker" data-hide-disabled="true" data-live-search="true">
			  ...
			  <div class="modal-body">
				...
				<div class="form-group">
                    ...
                    <select name="title2" class="form-control" id="title2">
                      ...
                      <a name="historico" id="historico" style="  font-size: 20px; float:right; cursor: pointer;">Histórico Cliente</a> 
					</div>
              </div>
				  <div class="form-group">
                  ...
                  <!-- é posto aqui em cda input o form a que este se dedica para depois no php conseguir
                    fazer o post de cada um -->
                     ...
                     <a name="editar" id="editar" style="float:right; font-size: 18px; cursor: pointer;">Editar Descrição Avaria</a> 
                  ...
                  <!-- Para puder fazer concluido a obra / assistencia -->            
                          <div class="checkbox">
      ...
      //quando o titulo2 (titulo do criar nova) muda os dados sao alterados
       $('#title').change(function() {
          var result = $(this).val().split('-');
                $.ajax({
                    url:'php/Calendario/detalhesGuia.php?nmr='+result[0],
                    complete: function (response) {
       ...
       $( "#ModalEdit" ).on('shown.bs.modal', function(){
           ...
           var nmr = $("[name=title2] option:selected").text().split('-');
           ...
           $("#editar").text("Editar Descrição Avaria");    
                ...
                $.ajax({
                    url:'php/Calendario/detalhesGuia.php?nmr='+nmr[0],
                    complete: function (response) {
           ...
           $.ajax({
                    url:'php/Calendario/tecnicosParaGuia.php?nmr='+nmr[0],
                    complete: function (response) {
        ...
        function verporFunc(param){
            ...
            if(id!="tec12"){
           document.getElementById("tec01").style.backgroundColor = "white";
           document.getElementById("tec02").style.backgroundColor = "white";
           document.getElementById("tec03").style.backgroundColor = "white";
           document.getElementById("tec04").style.backgroundColor = "white";
           document.getElementById("tec05").style.backgroundColor = "white";
           document.getElementById("tec06").style.backgroundColor = "white";
           document.getElementById("tec07").style.backgroundColor = "white";
           document.getElementById("tec08").style.backgroundColor = "white";
           document.getElementById("tec09").style.backgroundColor = "white";
           document.getElementById("tec10").style.backgroundColor = "white";
           document.getElementById("tec11").style.backgroundColor = "white";
          
            
            document.getElementById("tec01").style.color = "black";
            document.getElementById("tec02").style.color = "black";
            document.getElementById("tec03").style.color = "black";
            document.getElementById("tec04").style.color = "black";
            document.getElementById("tec05").style.color = "black";
            document.getElementById("tec06").style.color = "black";
            document.getElementById("tec07").style.color = "black";
            document.getElementById("tec08").style.color = "black";
            document.getElementById("tec09").style.color = "black";
            document.getElementById("tec10").style.color = "black";
            document.getElementById("tec11").style.color = "black";
