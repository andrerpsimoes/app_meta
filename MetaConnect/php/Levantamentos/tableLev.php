...
$statement = $conn_meta->prepare("select id, counter, id_cliente, observacoes, recebido_por, prioridade, data_hora, estado from servico where tipo_servico=1 and is_active=1");
$statement->execute();
